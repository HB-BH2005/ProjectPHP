                    ...
                    <form action="{{ route('admin.lessons.update', $lesson->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="5" required>{{ old('description', $lesson->description) }}</textarea>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $lesson->order) }}" min="0" required>
                            </div>
