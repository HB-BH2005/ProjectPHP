                    ...
                    <form action="{{ route('admin.levels.update', $level->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="nom" id="nom" class="form-control" value="{{ old('nom', $level->nom) }}" required>
                            </div>

                            <div class="col-12">
                                <label for="description">Description</label>
                                <textarea name="description" id="description" class="form-control" rows="5">{{ old('description', $level->description) }}</textarea>
                            </div>

                            <div class="col-12">
                                <button type="submit" class="btn btn-primary mt-3">Update Level</button>
                            </div>
                        </div>
                    </form>
                </div>
